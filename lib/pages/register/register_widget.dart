                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: FFLocalizations.of(context).getText(
                            '2et7t27h' /* Email Address */,
                          ),
                          labelStyle: FlutterFlowTheme.of(context).bodyMedium,
                          hintText: FFLocalizations.of(context).getText(
                            'tey9jop2' /* Email Address */,
                          ),
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: FFLocalizations.of(context).getText(
                            'otyb9eon' /* Choose Password */,
                          ),
                          labelStyle: FlutterFlowTheme.of(context).bodyMedium,
                          hintText: FFLocalizations.of(context).getText(
                            'sg30sk0d' /* Choose Password */,
                          ),
                          enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                              color: Color(0x00000000),
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: FFLocalizations.of(context).getText(
                            'yyn37o0f' /* Confirm Password */,
                          ),
                          labelStyle: FlutterFlowTheme.of(context).bodyMedium,
                          hintText: FFLocalizations.of(context).getText(
                            '3nrga2rs' /* Confirm Password */,
                          ),
                          enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                              color: Color(0x00000000),
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'fwrfibxk' /* Already have an account? */,
                          ),
